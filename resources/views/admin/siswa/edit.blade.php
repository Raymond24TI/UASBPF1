...
<div class="container mt-4">
    ...
    <form action="{{ route('siswa.update', $s->id_siswa) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama_siswa" class="form-control" value="{{ old('nama_siswa', $s->nama_siswa) }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="no_telp" class="form-control" value="{{ old('no_telp', $s->no_telp) }}">
        </div>

        <div class="mb-3">
            <label>Nama Wali</label>
            <input type="text" name="nama_wali" class="form-control" value="{{ old('nama_wali', $s->nama_wali) }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" name="tempat_tgl_lahir" class="form-control" value="{{ old('tempat_tgl_lahir', $s->tempat_tgl_lahir) }}">
        </div>
